 ...
 * This comment is auto generated on 2024/10/24 10:17:44, and it reflects the field definition at this given time.
...
// Always logging!
// Calls illumina_run_poolman() from the Installed Sheet Scope.
log.setToConsole(true); // Choose if we display the console block
log.println("==========");
log.println("running: illumina_run_postupdate(" + ILLUMINA_RUN["_path"] + "/"
                                                + param.getNewNodeId(ILLUMINA_RUN["_id"]) +" )");
illumina_run_poolman();
